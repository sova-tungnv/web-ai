...
export default function HairColor() {
  ...
  return (
    <div className="flex flex-col gap-6">
      <h1 className="text-3xl font-bold text-pink-600">Hair Color</h1>
      <p className="text-lg text-gray-700">
        Upload a photo to get hair color recommendations.
      </p>
      ...
      <div className="bg-white p-4 rounded-lg shadow-md">
        ...
        <div className="mt-4">
          <p className="text-gray-700">Result: (Gợi ý màu tóc sẽ hiển thị ở đây)</p>
        </div>
      </div>
    </div>
  );
